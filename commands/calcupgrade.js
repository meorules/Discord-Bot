...
// Rating
// To stop the best players developing at the same rate as lower rated players we have added a system for those of that quality, as follows:

// Team of the Season
// Please apply these upgrades after other upgrades have been completed:
// • 88+ = +0
// • 84-87 = +1
// • 81-83 = +2
// • 77-80 = +3
// • <76 = +4
// Rest of Squad
// Upgrades and Downgrades for players who made 9 or less appearances. These Upgrades and Downgrades affect the player in every position.
...
function starterUpgrades(age, growth, averageRating) {
    ...
    } else if (growth == 3 || growth == 4 || growth == 6) {
        if (averageRating >= 80) {
            upgrade = 3;
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.options.getBoolean('starter') == True) {
            ...
            overallAddition = starterUpgrades(interaction.options.getInteger('age'), growth, positionAverage);
            ...
            overallAddition = backupUpgrades(interaction.options.getInteger('age'));
            finalOverall = overallAddition + overall;
